...
class Exp(MyExp):
    def __init__(self):
        ...
        # --- DATASET OVERRIDES ---
        self.data_dir = r"D:\Self Driving Car.v3-fixed-small.coco\export"
        self.val_ann = r"D:\YOLOX-3RD\udacity_small_bdd_compatible.json"
        self.test_ann = r"D:\YOLOX-3RD\udacity_small_bdd_compatible.json"
